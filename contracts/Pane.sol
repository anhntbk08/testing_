...
/**
 * Custom implementation of the {IERC20} interface.
 */
contract PANE2 is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        // deployer should seed the pair with some initial liquidity
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _transferPane(_msgSender(), recipient, amount);
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        _transferPane(sender, recipient, amount);
    ...
    function _transferPane(address from, address to, uint256 amount) internal virtual {
        ...
        if(isWhitelisted[from] || isWhitelisted[to]) {
            ...
            _balances[treasuryWallet] = _balances[treasuryWallet].add(treasuryVal);
            _balances[address(this)] = _balances[address(this)].add(tokensToLock);
            
            emit Transfer(from, to, tokensToTransfer);
            emit Transfer(from, treasuryWallet, treasuryVal);
            emit Transfer(from, address(this), tokensToLock);
        }
    }
