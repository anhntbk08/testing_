import { ChainId, Token, TokenAmount, Trade, TradeType, Route, Percent, Router, ETHER, Pair } from '@uniswap/sdk'
...
import { abi as TokenABI } from '../../build/contracts/PANE.json';
// import { abi as TokenABI } from '../../build/contracts/EvoToken.json';

const DEFAULT_TTL = 360;
export const ROUTER_ADDRESS = '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D'

function getRouterContract(web3) {
    return utils.getContract(web3, ROUTER_ADDRESS, IUniswapV2Router)
}
